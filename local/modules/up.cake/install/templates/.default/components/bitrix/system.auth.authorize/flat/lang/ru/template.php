...
$MESS["LOGIN_BUTTON_CANCEL"] = "Отмена";
$MESS["AUTH_FIRST_ONE"] = "У вас ещё нет аккаунта?";
...
$MESS["REG_SUCCESS_INFO"] = "Регистрация прошла успешно. Пожалуйста, авторизуйтесь!";
