	...
	var RecipeCard = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(RecipeCard, [{
	    ...
	    value: function simpleCard(recipeData, image) {
	      return main_core.Tag.render(_templateObject || (_templateObject = babelHelpers.taggedTemplateLiteral(["\n\t\t\t\t<div class=\"card card-list\" id=\"", "\">\n\t\t\t\t\t\t<div class=\"card-image\">\n\t\t\t\t\t\t\t<figure class=\"image\">\n\t\t\t\t\t\t\t\t<img src='", "'>\n\t\t\t\t\t\t\t</figure>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"card-content\">\n\t\t\t\t\t\t\t<div class=\"content\">\n\t\t\t\t\t\t\t\t<div class=\"content-header\">\n\t\t\t\t\t\t\t\t\t<a class=\"title mb-2\" href=\"/detail/", "/\">", " </a>\n\t\t\t\t\t\t\t\t\t<button class=\"like ", "\" id=\"like-btn-", "\" value=\"", "\" onclick=\"window.CakeRecipeList.reaction.changeLike(this.value)\"></button>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t<hr>\n\t\t\t\t\t\t\t\t<p>", "</p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<footer class=\"card-footer\">\n\t\t\t\t\t\t\t<div class=\"card-footer-item\">\uD83D\uDD54 ", " \u043C\u0438\u043D</div>\n\t\t\t\t\t\t\t", "\n\t\t\t\t\t\t\t<div class=\"card-footer-item \"><a href=\"/users/", "/\">\uD83D\uDC68\u200D\uD83C\uDF73", "</a></div>\n\t\t\t\t\t\t</footer>\n\t\t\t\t\t</div>"])), recipeData.ID, image !== null && image !== void 0 ? image : '', recipeData.ID, recipeData.NAME, recipeData.USER_REACTION ? 'like-active' : '', recipeData.ID, recipeData.ID, this.getDescription(recipeData.DESCRIPTION), recipeData.TIME, recipeData.CALORIES !== '' && Number(recipeData.CALORIES) !== 0 ? "<div class=\"card-footer-item\">🔥" + recipeData.CALORIES + " \u043A\u0430\u043B\u043E\u0440\u0438\u0439</div> " : '', recipeData.UP_CAKE_MODEL_RECIPE_USER_ID, recipeData.UP_CAKE_MODEL_RECIPE_USER_NAME + ' ' + recipeData.UP_CAKE_MODEL_RECIPE_USER_LAST_NAME);
	    }
	  }, {
	    key: "profileCard",
	    value: function profileCard(recipeData, image) {
	      return main_core.Tag.render(_templateObject2 || (_templateObject2 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t\t<div class=\"column mt-5\">\n\t\t\t\t\t<div class=\"card card-list\" id=\"", "\">\n\t\t\t\t\t\t<div class=\"card-image\">\n\t\t\t\t\t\t\t<figure class=\"image\">\n\t\t\t\t\t\t\t\t<img src='", "'>\n\t\t\t\t\t\t\t</figure>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class=\"card-content\">\n\t\t\t\t\t\t\t<div class=\"content\">\n\t\t\t\t\t\t\t\t<a class=\"title mb-2\" href=\"/detail/", "/\">", " </a>\n\t\t\t\t\t\t\t\t<hr>\n\t\t\t\t\t\t\t\t<p>", "</p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<footer class=\"card-footer\">\n\t\t\t\t\t\t\t<div class=\"card-footer-item\">\u2764 \u041B\u0430\u0439\u043A\u0438: ", "</div> \t\n\t\t\t\t\t\t\t<a href=\"/recipe/edit/", "/\" class=\"card-footer-item button profile-button-edit\">\u0420\u0435\u0434\u0430\u043A\u0442\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u0435</a>\n    \t\t\t\t\t\t<button class=\"card-footer-item button profile-button-delete\" value=\"", "\" onclick=\" window.step = 1 ; window.CakeRecipeList.deleteRecipe(this.value);\">\u0423\u0434\u0430\u043B\u0435\u043D\u0438\u0435</button>\n\t\t\t\t\t\t</footer>\n\t\t\t\t\t</div>\n\t\t\t\t</div>"])), recipeData.ID, image !== null && image !== void 0 ? image : '', recipeData.ID, recipeData.NAME, this.getDescription(recipeData.DESCRIPTION), recipeData.REACTION !== '' ? recipeData.REACTION : 0, recipeData.ID, recipeData.ID);
	    }
	  }]);
	  return RecipeCard;
	}();
	...
	var RecipeMessage = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(RecipeMessage, [{
	    ...
	    value: function profileMessage() {
	      ...
	      return main_core.Tag.render(_templateObject2$1 || (_templateObject2$1 = babelHelpers.taggedTemplateLiteral(["<div class=\"profile-mes\"><a href=\"/recipe/create/\"><img src=\"/local/modules/up.cake/install/templates/cake/images/dishes.png\" alt=\"\"><p>\u0414\u043E\u0431\u0430\u0432\u044C\u0442\u0435 \u0432\u0430\u0448 \u043F\u0435\u0440\u0432\u044B\u0439 \u0440\u0435\u0446\u0435\u043F\u0442!</p></a></div>"])));
	    }
	  }]);
