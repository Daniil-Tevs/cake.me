INSERT IGNORE INTO up_cake_recipe(ID,NAME,DESCRIPTION,TIME,REACTION,USER_ID, CALORIES)
...
хрустящая корочка и влажная серединка. В торт также добавляют грецкие орехи или фисташки, а еще клюкву.',90,0,1, 435),
...
любимые макароны из 500 видов всевозможной пасты. Но только из твердых сортов пшеницы.',120,0,1, 250),
...
сухофрукты, орехи, свежие фрукты и даже картофель лишними не будут. Приятного аппетита!',30,0,1, 350);
...
INSERT IGNORE INTO up_cake_type(ID, NAME)
VALUES (1, 'грамм'),
       (2, 'мл'),
       (3, 'л'),
       (4, 'кг'),
